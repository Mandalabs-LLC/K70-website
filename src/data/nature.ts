...
export const natureData = [
    ...
    },
    {
        ...
        have been recorded in the broader Kangchenjunga landscape, showcasing an extraordinary diversity vital for ecological balance and 
        local livelihoods.
        <br/><br/>
    ...
    },
    {
        ...
        <br/><br/>
        Kangchenjunga Conservation Area’s varied flora and fauna play crucial roles in maintaining ecological integrity while also 
        supporting local cultures and economies. Sustainable practices are essential to ensure that this remarkable environment 
        can be preserved for future generations. The remarkable biodiversity and habitats of Kangchenjunga are truly a global treasure.
