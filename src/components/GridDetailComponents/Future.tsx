        ...
        <>
            ...
            <div className="flex flex-col justify-center items-center bg-white gap-4 px-4 py-8 md:gap-20 md:p-20 text-primary-light text-lg tracking-wider">
                <p>
                    ...
                    finance, promote tourism, and enhance overall living standards. <Link href="www.spnepal.org.np" className="text-[#2B76A3] underline">www.spnepal.org.np</Link>
                    <br /><br />
                ...
                <div className="flex flex-col md:flex-row justify-center gap-8 h-auto w-full">
                    {futureSecondSectionImages.map((data, index) => (
                        <div key={index} className="flex flex-col   items-center gap-2 ">
                            <Image onClick={() => openModal(data.image as any)} src={data.image} alt="img" className="shadow-md border-8 border-white" />
                ...
                <h2 className="text-blue-dark bebasNeue tracking-widest text-xl md:text-3xl text-center">
                    “Conserving nature whilst empowering communities of Kanchenjunga, the world’s third highest mountain” <br /><br />
