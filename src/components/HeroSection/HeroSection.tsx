    ...
    return (
        <div className='relative h-[684px] 2xl:h-[844px]'>
            ...
            <section className='absolute top-[120px] md:top-[347px] 2xl:top-[410px] md:left-16 w-full md:w-[644px] 2xl:w-[920px] h-auto'>
                <p className='text-primary bebasNeue px-4 md:px-0 text-2xl md:text-[40px] 2xl:text-5xl tracking-widest md:tracking-[6px] 2xl:tracking-[0.5rem] leading-10 md:leading-[3.5rem] 2xl:leading-[4.5rem]'>Celebrating a last legacy and working towards a promising future for Kanchenjunga </p>
            </section>
            ...
            <section className=' '>
                ...
                <div className='absolute right-[45px] top-[250px] h-[203px] w-[300px]  md:right-[360px] md:top-[300px] 2xl:right-[420px] 2xl:top-[350px] md:w-[333px] md:h-[248px] 2xl:w-[451px] 2xl:h-[328px] border-8 border-white flex justify-center items-center z-50'>
                    <video src='/video/K70_video.mp4' autoPlay muted loop  className='-z-10 object-cover h-[195px] md:h-[238px] 2xl:h-[320px]' />
                </div>
            </section>
        </div>
    )
