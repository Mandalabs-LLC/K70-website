    ...
    return (
        <div className='relative h-[684px] 2xl:h-[844px]'>
            ...
            <section className='absolute top-[120px] md:top-[347px] 2xl:top-[410px] md:left-16 w-full md:w-[400px] xl:w-[500px]  xxl:w-[644px] 2xl:w-[920px] h-auto'>
                <p className='text-primary bebasNeue px-4 md:px-0 text-2xl md:text-3xl lg:text-[40px] 2xl:text-5xl tracking-[1px] md:tracking-[2px] 2xl:tracking-[4px] leading-10 md:leading-[3.5rem] 2xl:leading-[4.5rem]'>
            ...
            {/* right section */}
            <section className=' '>
                <Image src={group} alt='group' className='bg-white absolute right-[164px] top-[445px] md:right-[188px] md:top-[190px] w-[200px] h-[123px] md:w-[265px] md:h-[189px] 2xl:w-[359px] 2xl:h-[255px] border-8 border-white' />
                <Image src={map} alt='map' className='bg-white absolute right-[32px] top-[520px] md:right-[85px] md:top-[330px] 2xl:top-[380px] w-[200px] h-[123px] md:w-[285px] md:h-[189px] 2xl:w-[359px] 2xl:h-[255px] border-8 border-white z-50' />
